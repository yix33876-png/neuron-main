...
Build and package a RK3506 Neuron release asset. The output tarball can be
uploaded to a GitHub or Codeup release.
...
mkdir -p "$output_dir"
asset="$output_dir/neuron-rk3506-${version}.tar.gz"
